...
import BuyerDrawer from "./Buyer_Drawer";
  ...
  return (
    <AppBar position="sticky" sx={{ backgroundColor: "#fff" }}>
      <Container maxWidth="xl">
        <Toolbar>
          {/* ArtySouq Logo Grid */}
          {/* <ImgTag src={require("../../Images/logo-remove.png")} alt="nft" />; */}
          <Grid container>
            <Grid item>
          ...
          <Grid container sx={{ justifyContent: "flex-end" }}>
            {isMatch ? (
              ...
              <Grid container justifyContent="flex-end" alignItems="center">
                <Typography sx={navItem}>nft's</Typography>
                <Typography sx={navItem}>artifacts</Typography>
